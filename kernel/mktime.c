 ...
 */
/* 这不是库函数，它仅供内核使用。因此我们不关心小于1970 年的年份等，但假定一切均
 * 很正常。同样，时间区域TZ 问题也先忽略。我们只是尽可能简单地处理问题。最好能找到一些公
 * 开的库函数(尽管我认为minix 的时间函数是公开的) */
/*
...
long kernel_mktime(struct tm * tm)
{
	...
	year = tm->tm_year - 70;	/* 从70 年到现在经过的年数(2 位表示方式), 因此会有2000年问题 */
